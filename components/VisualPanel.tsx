      ...
      <>
        ...
        {overlayActive && octree && <>
          ...
          <div className="segmented compact" role="group" aria-label="Unified octree lifecycle">
            ...
            <button className={gridOverlayMode === "band-residency" ? "active" : ""} aria-label="Inspect the pressure and surface bands against actual fine residency" onClick={() => selectOverlayMode("band-residency")}>All bands</button>
          </div>
