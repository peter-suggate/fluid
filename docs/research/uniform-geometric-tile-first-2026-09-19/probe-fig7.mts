...
} from "/Users/petersuggate/code/me/fluid/lib/core/fluid-pipeline";
...
} from "/Users/petersuggate/code/me/fluid/lib/core/performance-trace";
...
} from "/Users/petersuggate/code/me/fluid/lib/methods/uniform/webgpu-uniform-reference";
...
try {
  ...
  for (const variant of VARIANTS) {
    ...
    for (let frame = 1; frame <= SAMPLED_ADVANCES; frame += 1) {
      ...
      maxSpeeds.push(Number(info.maxSpeed_m_s ?? 0));
    ...
    report.push({
      ...
      perFrame: {
        ...
        maxSpeed_m_s: maxSpeeds.map((value) => Number(value.toFixed(4))),
      },
    });
    solver.destroy();
  }
