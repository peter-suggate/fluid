...
> Faithful Markdown extraction of the 11-page author manuscript. Body text, headings, captions, tables, algorithm numbering, acknowledgments, and references are preserved; figures and display equations are embedded as lossless page crops where text extraction would alter notation. Source: [Narita et al. manuscript](https://graphics.c.u-tokyo.ac.jp/archives/sg2025narita.pdf). Local source PDF: [`sg2025narita.pdf`](sg2025narita.pdf).

FUMIYA NARITA, The University of Tokyo and GAME FREAK Inc., Japan
NIMIKO OCHIAI, GAME FREAK Inc., Japan

TAKASHI KANAI, The University of Tokyo, Japan
RYOICHI ANDO, Unaffiliated, Japan


![](sg2025narita-assets/sg2025narita.pdf-0001-03.png)
...
![](sg2025narita-assets/sg2025narita.pdf-0003-11.png)
...
![](sg2025narita-assets/sg2025narita.pdf-0003-22.png)
...
![](sg2025narita-assets/sg2025narita.pdf-0004-04.png)


Fig. 3. Pressure Gradient Operator


![](sg2025narita-assets/sg2025narita.pdf-0004-06.png)



![](sg2025narita-assets/sg2025narita.pdf-0004-07.png)
...
![](sg2025narita-assets/sg2025narita.pdf-0004-09.png)
...
![](sg2025narita-assets/sg2025narita.pdf-0004-12.png)
...
![](sg2025narita-assets/sg2025narita.pdf-0004-20.png)
...
![](sg2025narita-assets/sg2025narita.pdf-0004-22.png)
...
| Line | Operation | Reference |
|---:|---|---|
| 1 | `Function Advance_Step():` | |
...
![](sg2025narita-assets/sg2025narita.pdf-0005-04.png)
...
![](sg2025narita-assets/sg2025narita.pdf-0006-01.png)
...
![](sg2025narita-assets/sg2025narita.pdf-0007-00.png)
...
_Numerical Damping._ Our method exhibits visually satisfactory results for many practical scenarios, except that it inevitably introduces noticeable damping. This limitation is consistent with previous spatially adaptive methods such as [Ando and Batty 2020] in that coarse grid approximations tend to wipe out detail flow that cannot be captured with the cells.
...
| Scene | Resol. | Method | Total cells | Assemble matrix (seconds) | Solve Poisson's equation (seconds) | Initial residual | Residual returned | Iterations |
|---|---:|---|---:|---:|---:|---:|---:|---:|
| Fig. 5 | 256<sup>3</sup> | Uniform | 6,779,709 | 2.897 | 28.456 | 1.0 × 10<sup>−2</sup> | 1.0 × 10<sup>−6</sup> | 229 |
|  |  | Tall | 2,556,400 | 1.795 | 12.108 | 3.3 × 10<sup>−2</sup> | 3.0 × 10<sup>−6</sup> | 264 |
|  |  | Ours | 126,031 | 0.061 | 0.318 | 9.9 × 10<sup>−2</sup> | 8.0 × 10<sup>−6</sup> | 95 |
| Fig. 6 | 256<sup>3</sup> | Uniform | 6,054,119 | 2.918 | 26.452 | 3.5 × 10<sup>−2</sup> | 3.0 × 10<sup>−6</sup> | 241 |
|  |  | Tall | 2,828,746 | 2.527 | 13.529 | 3.0 × 10<sup>−1</sup> | 2.6 × 10<sup>−5</sup> | 269 |
|  |  | Ours | 568,377 | 0.339 | 1.416 | 4.1 | 3.5 × 10<sup>−4</sup> | 140 |
| Fig. 1 | 512 × 192<sup>2</sup> | Uniform | 5,347,016 | 5.125 | 30.777 | 2.9 × 10<sup>−2</sup> | 3.0 × 10<sup>−6</sup> | 220 |
|  |  | Tall | 2,288,191 | 3.171 | 15.618 | 8.3 × 10<sup>−2</sup> | 6.0 × 10<sup>−6</sup> | 252 |
|  |  | Ours | 316,432 | 0.351 | 3.529 | 5.2 × 10<sup>−1</sup> | 4.9 × 10<sup>−5</sup> | 169 |

![](sg2025narita-assets/fig-7-timing.jpg)
...
![](sg2025narita-assets/sg2025narita.pdf-0009-01.png)
