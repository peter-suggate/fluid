...
import { OCTREE_LOSASSO_ADAPTIVE_PHI_RECEIPT_WORDS } from "../octree-shared/octree-losasso-receipt-abi";

export const OCTREE_LOSASSO_ADAPTIVE_PHI_MAGIC = 0x4150_4849;
export const OCTREE_LOSASSO_ADAPTIVE_PHI_CONTROL_WORDS = 20;
/** The engine's step-snapshot ring sizes its slot from this, so the count is
 * declared once in `octree-shared/octree-losasso-receipt-abi.ts` and named
 * here. */
export { OCTREE_LOSASSO_ADAPTIVE_PHI_RECEIPT_WORDS } from "../octree-shared/octree-losasso-receipt-abi";
