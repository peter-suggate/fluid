 ...
 *   node --import tsx lib/methods/adaptive-volume/features/pressure-inspection/verification/probe.ts --scene=mini32
 */
...
await acquireWebGPUExclusiveLock("dawn-probe", "lib/methods/adaptive-volume/features/pressure-inspection/verification/probe.ts");
try {
