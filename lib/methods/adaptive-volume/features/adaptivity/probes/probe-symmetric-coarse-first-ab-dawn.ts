...
import { getSceneDefinition, SPARSE_CM12_SYMMETRIC_EXPANSION_METHOD_PROFILE } from "../../../../../core/scenes";
...
try {
  ...
  const residentWGSLHash = createHash("sha256").update(await readFile(new URL(
    "../../../webgpu-sparse-cm12-resident.wgsl.ts", import.meta.url))).digest("hex");
