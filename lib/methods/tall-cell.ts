...
const params: MethodParamSpec[] = [
  ...
  { kind: "number", key: "regularLayers", label: "Surface band layers", unit: "cells", min: 12, max: 64, step: 4, digits: 0, default: 12, tier: "fine", hint: "Cubic cells kept around the free surface. The band grows automatically if the surface spans more; large values can intentionally reach the uniform-grid limit in shallow scenes." },
...
export const tallCellMethod: SimulationMethod = {
  ...
  presetFor: (quality) => {
    ...
    return { pressureCycles: 8, pressureWarmStart: "off", pressureDefectCorrection: "off", regularLayers: preset.regularLayers, maximumNeighborDelta: preset.maximumNeighborDelta, maximumTallHeight: preset.maximumTallHeight, remeshInterval: preset.remeshInterval };
  },
