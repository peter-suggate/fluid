...
const params: MethodParamSpec[] = [
  { kind: "number", key: "jacobiIterations", label: "Jacobi iterations", unit: "iterations", min: 16, max: 400, step: 8, digits: 0, default: 64, tier: "coarse", hint: "Pressure relaxation sweeps per step. The uniform grid uses damped Jacobi, so deep scenes need many sweeps." },
...
export const uniformMethod: SimulationMethod = {
  ...
  shortLabel: "Uniform",
  badge: "UNIFORM GRID",
  description: "Full-depth cubic comparison grid with conservative VOF transport.",
  detail: "the matched full-depth cubic comparison grid with conservative VOF transport and weighted Jacobi projection",
  backend: "webgpu",
