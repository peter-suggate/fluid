 ...
 */
import { OCTREE_COARSE_PHI_BYTES, OCTREE_COARSE_PHI_FLAG } from "../../core/levelset-consumer-abi";

/**
 * The row stride and its flag bits are the half a consumer must agree with,
 * so they live in `lib/core/levelset-consumer-abi.ts` beside the buffer set
 * that carries them. Re-exported here because everything that *builds* a
 * correction reaches for them through this module.
 */
export { OCTREE_COARSE_PHI_BYTES, OCTREE_COARSE_PHI_FLAG } from "../../core/levelset-consumer-abi";
