...
import { OCTREE_AIR_SUPPORT_LAYOUT_VERSION, OCTREE_AIR_SUPPORT_OWNER_HASH,
  ...
  type OctreeAirVelocitySupportLayout } from "./octree-air-velocity-support-abi";
...
/**
 * The compact sorted level-set directory this build corrects in place.
 *
 * Only the two fields the build addresses are named, so any coarse-dynamics
 * backend's published sample source satisfies it as-is.
 */
export interface OctreeCoarseSummaryDirectory {
...
export class WebGPUOctreeCoarseSummary {
  ...
  constructor(private readonly device: GPUDevice,
    private readonly coarse: OctreeCoarseSummaryDirectory,
    dimensions: readonly [number, number, number],
