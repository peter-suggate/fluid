...
/**
 * The registered simulation methods a smoke lane may run.
 *
 * Kept as data rather than imported from the registry so an authored suite
 * stays inspectable without installing methods or initializing Dawn. A lane
