...
const definitions = [
  ...
  { mode: "candidate-work", label: "Candidate BVH work", description: "Analytic primitive BVH nodes and leaves tested by the camera ray.", category: "Primary ray", palette: "sequential", legend: sequential },
  ...
  { mode: "exhaustion", label: "Traversal failures", description: "Budget exhaustion and invalid traversal or candidate data.", category: "Summary", palette: "failure", legend: failure },
