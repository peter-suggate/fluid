...
import { CPUPerformanceTrace, GPUPassTimestampRecorder } from "../../../core/performance-trace";
...
const OWNER_SOURCE: Record<RenderFrameStageOwner, string> = {
  world: "lib/svo/features/construction/webgpu-svo-sparse-bricks.ts",
  renderer: "lib/core/webgpu-renderer.ts",
  water: "lib/core/webgpu-water-pipeline.ts",
  svo: "lib/svo/pipeline/webgpu-svo-dry-scene.ts",
};
