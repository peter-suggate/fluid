...
import { primaryQuery, type PrimaryQueryState } from "../features/primary-visibility/persistence";
...
const tuning = combineQueryCodecs<Partial<SvoRenderTuning>>([constructionTuningQuery, radianceTuningQuery]);
