import { mortonEncode3D } from "../construction/sparse-brick-octree";
import type { SparseBrickProxyOccupancy } from "../../../core/adaptive-sparse-brick-plan";
import type { SvoScenePrimitiveBuild } from "../scene-publication/svo-scene-primitives";
import type { SparseSceneAxisAlignedBounds } from "../../../core/webgpu-sparse-scene-proxies";
import { svoPrimitiveWGSL, SVO_PRIMITIVE_RECORD_WORDS, SVO_SMOOTH_UNION_CLUSTER_ARENA_WORDS } from "../../contracts/svo-primitive-abi";
import { svoClusterArenaDecodeWGSL } from "../construction/svo-cluster-arena";
import { svoFieldProgramWGSL, SVO_FIELD_PROGRAM_BLOCK_WORDS } from "../scene-publication/svo-field-program";
import { svoProceduralNoiseWGSL } from "../materials/svo-procedural-material";
import { SVO_DRY_SCENE_ARENA_LAYOUT } from "../shading/program";
