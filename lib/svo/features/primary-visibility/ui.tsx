...
} from "../diagnostics/svo-render-diagnostics";
import {
  ToolstripMenuButton,
  ToolstripMenuItem,
  ToolstripRow,
...
export function PrimaryTraversalRow() {
  ...
  const lastView = session.ui((state) => state.svoLastPrimaryWorkView) as WorkView;
...
/** The same command and definition can be hosted in any registered panel. */
