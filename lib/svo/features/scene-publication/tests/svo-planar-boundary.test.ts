...
import { planAdaptiveSparseBrickOctree } from "../../../../core/adaptive-sparse-brick-plan";
import { packSparseBrickPlan, SPARSE_BRICK_INVALID_INDEX,
  SPARSE_BRICK_LEAF_TERMINAL } from "../../construction/sparse-brick-octree";
import { traversePackedSvo } from "../../primary-visibility/webgpu-svo-traversal";
import {
...
import { buildEnvironmentProxyCatalog, environmentProxyPrimitives,
  type EnvironmentProxyPrimitive } from "../../../../core/voxel-environments";
import { SVO_DRY_SCENE_BINDING_CONTRACT } from "../../../pipeline/webgpu-svo-dry-scene";
import { createSvoDrySceneFragmentWGSL } from "../../shading/program";
import { boxSolidVoxelShell, createSolidWorld, sampleSolidWorld } from "../../../../core/solid-world";
import { getScenePreset } from "../../../../core/scenes";
