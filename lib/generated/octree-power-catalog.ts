...
export const OCTREE_GENERATED_POWER_CATALOG_MANIFEST = Object.freeze({
  ...
  "rowTemplateVersion": 1,
  "regularCaseId": 0,
  "maximumDynamicBoundarySlots": 30,
  "worstReconstructionResidual": 3.9601817158896324e-8,
  "generatorVersion": 7,
  "generatorHash": "0add7aac922af6dee8d67c3288a3e6538ef997f3efce0fe6cc91d9d7ec1e8f6b",
  "binarySha256": "d91735f19a173a2dfe567325ebba63a997a68296d73f9eb85f55a7c3ea21050f"
} as const);
...
export function decodeGeneratedOctreePowerCatalog(data: ArrayBuffer): GeneratedOctreePowerCatalogViews {
  ...
  const h = new Uint32Array(data, 0, 40);
