 ...
 *
 * See `lib/core/refinement-regions.ts` for the ladder and the lattice, and
 * `lib/methods/octree-shared/octree-refinement-regions.ts` for the containment
 * contract and for why this is a uniform-tier input.
 */
