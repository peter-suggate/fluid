...
export const VISUAL_LAYERS = [
  ...
  { id: "pages", requires: ["pages"], label: "Domain pages", color: "#b39bea", opacity: 0.65, mode: 27, description: "Accepted simulation-domain pages. Purple cells belong to a resident page. During the initial Uniform Geometric migration, all authored pages remain resident; SIM shows the migration status." },
