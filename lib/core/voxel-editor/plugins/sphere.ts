...
import { beginShapeGesture, sizeControl, planeControl, mirrorControl } from "../geometry";
...
export const sphereTool: VoxelToolPlugin = {
  ...
  ui: { label: "Sphere", hint: "Place a voxel sphere; drag to move it along the starting plane.", group: "Construct", order: 4,
    icon: "M12 3a9 9 0 1 0 0 18a9 9 0 1 0 0-18", controls: [sizeControl, planeControl, mirrorControl] },
