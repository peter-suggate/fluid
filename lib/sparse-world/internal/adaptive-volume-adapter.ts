...
import type { SparseCM12PressureJournalCapacityRequest } from "../../methods/adaptive-volume/features/pressure-inspection/definition";
import type { SparseAtlasCompositeGrid } from
  "../../methods/adaptive-volume/sparse-atlas-composite-projection";
import type { SparseAdaptiveMassAtlas } from
  "../../methods/adaptive-volume/sparse-brick-atlas";
import type { SparseCM12RigidResources } from
  "../../methods/adaptive-volume/webgpu-sparse-cm12-rigid-coupling";
...
} from "./adaptive-volume-device-library";
...
export { CM12SparseWorldDevice } from "./adaptive-volume-device-library";
