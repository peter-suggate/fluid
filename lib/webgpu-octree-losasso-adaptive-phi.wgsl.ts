...
fn publishTopologyEvidenceRows(@builtin(global_invocation_id)gid:vec3u){
 ...
 // Mass supplies the nodal sign; the redistanced SDF retains metric curvature
 // whenever it agrees. A broad four-octant sub-grid sheet may retain negative
 // phi on the air side, while one/two-octant tendrils cannot become fingers.
 // Closed side walls always retain the raw-mass sign until physical contact.
