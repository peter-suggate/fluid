...
test("ITR1 WGSL compiles packet ballots without legacy/global topology walks", () => {
  ...
  assert.match(source, /fn fixtureDynamicClosureApplyTRA/);
  ...
  assert.match(source, /dca1MarkRowMask/);
  assert.match(source, /fixtureDynamicClosureScatterGammaSnapshotRow/);
  assert.match(source, /fixtureDynamicClosureScatterGammaRefinementRow/);
