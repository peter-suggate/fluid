// Frozen pre-reuse implementation. This is a byte-output compatibility oracle,
// not a second production parser. Preserve its lexical behavior when refactoring.
/**
 ...
 */
export function referenceSparseCM12WGSLForEntryPoints(source: string, roots: readonly string[]): string {
