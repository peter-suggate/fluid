...
test("compact publication rejection reports header and control evidence before abort", async () => {
  ...
  assert.match(smoke,
    /globalFineFaceBandControl[\s\S]*readBufferBinding[\s\S]*64[\s\S]*globalFineFaceBandTransitionControl[\s\S]*readBufferBinding[\s\S]*128[\s\S]*globalFineFaceBandTransientPowerControl[\s\S]*readBufferBinding[\s\S]*64[\s\S]*globalFineFaceBandPointFieldControl[\s\S]*readBufferBinding[\s\S]*32[\s\S]*globalFineFaceBandPowerPublicationControl[\s\S]*readBufferBinding[\s\S]*64[\s\S]*globalFinePowerVelocityControl[\s\S]*readBufferBinding[\s\S]*32[\s\S]*globalFinePowerVelocitySampleControl[\s\S]*readBufferBinding[\s\S]*32/,
