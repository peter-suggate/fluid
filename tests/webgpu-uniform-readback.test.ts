...
test("uniform and quadtree wrapper telemetry reuse their MAP_READ buffers", () => {
  ...
  assert.match(rigidHelper, /this\.rigidReadbackBuffer \?\?=/, "rigid loads lazily allocate one staging buffer");
