...
import { fluidPipelinePhaseCosts, measureFluidPipelineStage } from "../lib/core/fluid-pipeline";
...
const sourceHashes = Object.fromEntries(await Promise.all([
  ...
  new URL(`../lib/methods/adaptive-mass/${name}`, import.meta.url))).digest("hex")])));
